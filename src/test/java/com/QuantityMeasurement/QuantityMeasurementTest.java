...
public class QuantityMeasurementTest {
    ...
    public void givenNullFeetAndNullFeet_shouldThrowException() {
        try {
            ...
            QuantityMeasurement feet1 = new QuantityMeasurement(QuantityMeasurement.Unit.FEET, null);
            QuantityMeasurement feet2 = new QuantityMeasurement(QuantityMeasurement.Unit.FEET, null);
            Assert.assertEquals(feet1,feet2);
    ...
    public void givenValueCheckForFeet_whenReferenceEquals_shouldReturnResult() {
        QuantityMeasurement feet1 = new QuantityMeasurement(QuantityMeasurement.Unit.FEET, 10.0);
        QuantityMeasurement feet2 = new QuantityMeasurement(QuantityMeasurement.Unit.FEET, 10.0);
        Assert.assertEquals(feet1, feet2);
    }

    @Test
    public void givenValueCheckForFeet_whenTypeEquals_shouldReturnResult() {
        QuantityMeasurement feet1 = new QuantityMeasurement(QuantityMeasurement.Unit.FEET, 5.0);
    ...
    public void givenNullInchAndNullInch_shouldThrowException() {
        try {
            ...
            QuantityMeasurement inch1 = new QuantityMeasurement(QuantityMeasurement.Unit.INCH, null);
            QuantityMeasurement inch2 = new QuantityMeasurement(QuantityMeasurement.Unit.INCH, null);
            Assert.assertEquals(inch1,inch2);
        } catch (QuantityException e) {
            Assert.assertEquals(QuantityException.ExceptionType.NULL_VALUE_EXCEPTION, e.type);
        }
    ...
    public void givenValueCheckForInch_whenReferenceEquals_shouldReturnResult() {
        QuantityMeasurement inch1 = new QuantityMeasurement(QuantityMeasurement.Unit.INCH, 10.0);
        QuantityMeasurement inch2 = new QuantityMeasurement(QuantityMeasurement.Unit.INCH, 10.0);
        Assert.assertEquals(inch1, inch2);
    }
    ...
    public void givenValueCheckForInch_whenTypeEquals_shouldReturnResult() {
        ...
        QuantityMeasurement inch2 = new QuantityMeasurement(QuantityMeasurement.Unit.INCH, 5.0);
        Assert.assertEquals(inch1, inch2);
    }
